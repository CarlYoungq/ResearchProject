...
from rev_mod import RevViT_Momentum
...
parser.add_argument(
    "--epochs", default=50, type=int, help="number of classes in the dataset"
)

# Transformer options
parser.add_argument("--model", default="momentumvit", type=str, help="model name")
parser.add_argument(
    "--embed_dim",
    default=256,
    type=int,
...
trainloader = torch.utils.data.DataLoader(
    ...
    trainset, batch_size=args.bs, shuffle=True, num_workers=0
)
...
testloader = torch.utils.data.DataLoader(
    ...
    testset, batch_size=args.bs, shuffle=False, num_workers=0
)
